...
def get_top_SNPs_chi2():
    # Top SNPs
    top500_SNPs_chi2 = "Data/TopSNPs/chi2/top1000_SNPs_chi2.txt"
    top500_SNPs_chi2_binary = "Data/TopSNPs/chi2/top1000_SNPs_chi2_binary.txt"
    ...
    top500_SNPs_chi2_indices = pd.read_csv(top500_SNPs_chi2_indices_file, nrows=1000)["Feature"].tolist()
...
def get_top_SNPs_rf():
    # Top SNPs
    top500_SNPs_rf = "Data/TopSNPs/rf/top2000_SNPs_40it_rf.txt"
    top500_SNPs_rf_binary = "Data/TopSNPs/rf/top2000_SNPs_40it_rf_binary.txt"
    top500_SNPs_rf_indices_file = "combined_feature_importances_top_100.csv"
    raw_data_cleaned = "Data/RawData/raw_data_cleaned.txt"
    ...
    with open("rf_40_it_indices.txt", "w") as file:
...
def get_top_SNPs_lasso():
    # Top SNPs
    top500_SNPs_lasso = "Data/TopSNPs/Lasso/top500_SNPs.txt"
    top500_SNPs_lasso_binary = "Data/TopSNPs/Lasso/top500_SNPs_binary.txt"
    top500_SNPs_lasso_indices_file = "Data/TopSNPs/Lasso/LASSO_SNPs.csv"
    raw_data_cleaned = "Data/RawData/raw_data_cleaned.txt"

    # Load the first 500 rows of the first column as a list
    top500_SNPs_lasso_indices = (
        pd.read_csv(top500_SNPs_lasso_indices_file, nrows=500)["SNP"]
        #.str.replace("Feature ", "", regex=False)  # Remove "Feature "
        .astype(int)  # Convert to integers
        .tolist()  # Convert to list
    )

    with open("lasso_indices.txt", "w") as file:
        for item in top500_SNPs_lasso_indices:
            file.write(f"{item}\n")
    ...
    print("filtering raw_data by significant SNPs")
    extract_specified_columns(
        raw_data_cleaned, top500_SNPs_lasso, top500_SNPs_rf_indices
    )

    # compress top_snps to binary
    print("compressing significant SNPs to binary")
    to_binary(top500_SNPs_lasso, top500_SNPs_lasso_binary)
