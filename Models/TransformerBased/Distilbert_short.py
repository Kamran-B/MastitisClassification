...
def main(seed=42, epochs=4, printStats=True, savePerf=False, top_snps=None):
    ...
    train_loader = DataLoader(GeneticDataset(X_train_aug, y_train_aug, tokenizer), batch_size=12, shuffle=True)
    test_loader = DataLoader(GeneticDataset(X_test_aug, y_test_aug, tokenizer), batch_size=12, shuffle=False)
...
if __name__ == "__main__":
    EvalScript(1, "Data/TopSNPs/chi2/top500_SNPs_chi2_binary.txt", "Logging/Transformer/chi2_top500.json")
