def train_transformer_model(
    ...
    train_loader = DataLoader(LGSCCDataset(scaled_train, train_targets), batch_size=batch_size, shuffle=True, collate_fn=collate_fn)
    val_loader = DataLoader(LGSCCDataset(scaled_val, val_targets), batch_size=batch_size, collate_fn=collate_fn)
